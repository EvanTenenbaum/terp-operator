...
import { EMPTY_ROWS, moneyish, dateish } from './operations/shared';
    ...
    <>
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 min-h-0">
          <GridView viewKey="disputes" entityType="invoiceDispute" />
        </div>

        {canResolve && selectedDispute ? (
          <div className="control-band subtle-band gap-2">
            <button
