export function MobileContactProfileView() {
  return (
    <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <p className="text-base font-semibold" style={{ color: 'var(--m-ink)' }}>Contact Profile</p>
      <p className="mt-2 text-sm" style={{ color: 'var(--m-muted)' }}>Available after CAP-033 Phase 4 backend queries land.</p>
      <p className="mt-1 font-mono text-xs" style={{ color: 'var(--m-muted-2)' }}>Needs: queries.contactProfile</p>
    </div>
  );
}
