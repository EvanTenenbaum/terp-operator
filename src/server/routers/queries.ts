...
const STATUS_COUNTS_REGISTRY: Record<string, StatusCountsEntry> = {
  purchaseOrders:      { table: 'purchase_orders',      statusEnum: PurchaseOrderStatus,      minRole: 'operator' },
  purchaseOrderLines:  { table: 'purchase_order_lines',  statusEnum: PurchaseOrderLineStatus,  minRole: 'operator' },
  salesOrders:         { table: 'sales_orders',          statusEnum: SalesOrderStatus,         minRole: 'operator' },
  salesOrderLines:     { table: 'sales_order_lines',     statusEnum: SalesOrderLineStatus,     minRole: 'operator' },
  purchaseReceipts:    { table: 'purchase_receipts',     statusEnum: PurchaseReceiptStatus,    minRole: 'operator' },
  batches:             { table: 'batches',               statusEnum: BatchStatus,              minRole: 'operator', baseWhere: 'archived_at IS NULL' },
  invoices:            { table: 'invoices',              statusEnum: InvoiceStatus,            minRole: 'operator' },
  payments:            { table: 'payments',              statusEnum: PaymentStatus,            minRole: 'operator' },
  vendorBills:         { table: 'vendor_bills',          statusEnum: VendorBillStatus,         minRole: 'operator' },
  vendorPayments:      { table: 'vendor_payments',       statusEnum: VendorPaymentStatus,      minRole: 'manager' },
  pickLists:           { table: 'pick_lists',            statusEnum: PickListStatus,           minRole: 'operator' },
  fulfillmentLines:    { table: 'fulfillment_lines',     statusEnum: FulfillmentLineStatus,    minRole: 'operator' },
  connectorRequests:   { table: 'connector_requests',    statusEnum: ConnectorRequestStatus,   minRole: 'operator' },
  ...
  matchmakingMatches:  { table: 'matchmaking_matches',   statusEnum: MatchmakingMatchStatus,   minRole: 'operator' },
  invoiceDisputes:     { table: 'invoice_disputes',      statusEnum: InvoiceDisputeStatus,     minRole: 'operator' },
  photographyQueue:    { table: 'photography_queue',     statusEnum: PhotographyQueueStatus,   minRole: 'operator' },
  items:               { table: 'items',                 statusEnum: ItemStatus,               minRole: 'operator' },
};
