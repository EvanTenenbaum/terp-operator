...
### 2. Your First Read (3 files, ~10 minutes)

| Order | File | Lines | Why |
|-------|------|-------|-----|
| **1st** | [MASTER-EXECUTION-DOCUMENT.md](./MASTER-EXECUTION-DOCUMENT.md) | 1543 | **Single source of truth.** All specs, tasks, design rules. |
| **2nd** | [AI-TODO.md](./AI-TODO.md) | — | **Active task state.** What's done/in-progress/blocked. |
| **3rd** | [HANDOFF.md](./HANDOFF.md) | — | **How to resume work.** Pick up where last agent left off. |
...
├── MASTER-EXECUTION-DOCUMENT.md           ← Single source of truth
