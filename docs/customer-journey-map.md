...
| 6 | Payments / AR | 🔄 Partial | Phase 3 | FIFO auto-allocation may require manual step (verify J05) |
| 7 | Vendor Bills / AP | ✅ Complete | Phase 3 | — |
| 8 | Closeout | ✅ Complete | Phase 5 | — |
| 9 | Recovery | ✅ Complete | Phase 5 | — |
| 10 | Matchmaking | 🔄 Partial | Phase 2+ | Status lifecycle unconstrained (DYN-H4, issue #27) |
...
| 13 | Photography / Media | ✅ Complete | Phase 2 | — |
...
|------|---------|--------|--------------|-----------------|
| FIFO auto-allocation execution | J6 (Payments/AR), B2 | DYN-H3 / Issue #26 | `logPayment` may not auto-allocate on FIFO intent; operator must manually run `allocatePayment` | Phase 3 regression — verify or fix in next patch |
| Matchmaking status lifecycle | J10 (Matchmaking) | DYN-H4 / Issue #27 | `customerNeeds` and `vendorSupply` have no enforced status transitions; any value accepted | Phase 7 or standalone ticket |
| Contact merge / deduplicate UI | Contacts (cross-journey) | TODO in `ContactsView.tsx` | Planned, not implemented. No command exists. | Phase 7 or post-launch |
...
| **Phase 3** — Money Loop | Payments/AR (J6), Vendor Bills/AP (J7), Credit Review (J12) | ✅ Complete (J6 FIFO pending verify) |
...
| **Post-launch** | Matchmaking lifecycle (DYN-H4), Contact merge UI | ⏳ Planned |
